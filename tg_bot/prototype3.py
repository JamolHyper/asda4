...
conv_handler = ConversationHandler(
    ...
    states={
        'name': [MessageHandler(filters.Filters.text, get_name)],
        'date': [MessageHandler(filters.Filters.text, get_date)],
        'tractor': [MessageHandler(filters.Filters.text, get_tractor)],
        'shift': [MessageHandler(filters.Filters.text, get_shift)],
        'operator': [MessageHandler(filters.Filters.text, get_operator)],
        'fuel': [MessageHandler(filters.Filters.text, get_fuel)],
        'time': [MessageHandler(filters.Filters.text, get_time)],
        'motor_hours': [MessageHandler(filters.Filters.text, get_motor_hours)],
        'motor_hours_before':[MessageHandler(filters.Filters.text, get_motor_hours_before)],
    },
